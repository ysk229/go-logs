...
func ColorLog(lev string, format string, s ...interface{}) string {
	...
	case "INFO":
		return Info(format, s...)
	case "WARN":
		return Warn(format, s...)

	case "ERROR":
		return Error(format, s...)
	case "FATAL":
		return Fatal(format, s...)
	default:
		return colorPrint(format, ansi.ColorCode("38"), s...)
	}
}
...
func Debug(format string, s ...interface{}) string {
	return colorPrint(format, ansi.ColorCode("blue"), s...)
}

func Warn(format string, s ...interface{}) string {
	return colorPrint(format, ansi.ColorCode("yellow"), s...)
}

func Error(format string, s ...interface{}) string {
	return colorPrint(format, ansi.ColorCode("red"), s...)
}

func Fatal(format string, s ...interface{}) string {
	return colorPrint(format, ansi.ColorCode("41"), s...)
}

func Timestamp(format string, s ...interface{}) string {
	return colorPrint(format, ansi.ColorCode("37"), s...)
}
